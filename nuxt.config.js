	...
	*/
	head: {
		...
		meta: [
			...
			{ hid: 'og:url', property: 'og:url', content: 'https://angry-curran-3b17d4.netlify.app' },
			{ hid: 'og:title', property: 'og:title', content: 'サイト名' },
			{ hid: 'og:description', property: 'og:description', content: '共通ディスクリプション' },
			{ hid: 'og:image', property: 'og:image', content: 'https://angry-curran-3b17d4.netlify.app/img/ogp/common.jpg' },
